...
int main(int argc, const char* argv[])
{
    ...
    pantalla.show();
    Joc joc;
    string fitxerInicial = "./data/Games/tauler_inicial.txt";
    
    

    joc.inicialitza(MODE_JOC_REPLAY, fitxerInicial, "./data/Games/moviments.txt");
    do
    {
    ...
    joc.finalitza(MODE_JOC_NORMAL, "./data/Games/moviments.txt");
